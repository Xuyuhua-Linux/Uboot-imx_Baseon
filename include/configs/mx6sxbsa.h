 ...
 *
 * Configuration settings for the NXP i.MX6SX Broadcast Smart Antenna board.
 *
 * SPDX-License-Identifier:	GPL-2.0+
 */

#ifndef __MX6SX_BSA_CONFIG_H
#define __MX6SX_BSA_CONFIG_H
